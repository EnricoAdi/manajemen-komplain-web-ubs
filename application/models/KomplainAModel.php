...
class KomplainAModel extends CI_Model
{
    ...
    {  
        ...
        JOIN SUB_TOPIK1 ST1 ON ST1.SUB_TOPIK1 = KA.SUB_TOPIK1 and ST1.KODE_TOPIK = KA.TOPIK
        JOIN SUB_TOPIK2 ST2 
    ...
    public function fetchForDivisi($KODEDIV,$status){ 
        if ($status == 'all') {
            ...
            JOIN SUB_TOPIK1 S1 ON S1.SUB_TOPIK1 = KA.SUB_TOPIK1 ON S1.SUB_TOPIK1 = KA.SUB_TOPIK1 and S1.KODE_TOPIK = KA.TOPIK
            JOIN SUB_TOPIK2 S2  ON S2.SUB_TOPIK2 = KA.SUB_TOPIK2 ON S2.SUB_TOPIK1 = KA.SUB_TOPIK1 and S2.KODE_TOPIK = KA.TOPIK
    ...
    public function fetchComplainSudahDiisi($KODEDIV){ 
        ...
        JOIN SUB_TOPIK1 S1 ON S1.SUB_TOPIK1 = KA.SUB_TOPIK1 ON S1.SUB_TOPIK1 = KA.SUB_TOPIK1 and S1.KODE_TOPIK = KA.TOPIK
            JOIN SUB_TOPIK2 S2  ON S2.SUB_TOPIK2 = KA.SUB_TOPIK2 ON S2.SUB_TOPIK1 = KA.SUB_TOPIK1 and S2.KODE_TOPIK = KA.TOPIK
        WHERE T.DIV_TUJUAN = $KODEDIV AND KA.STATUS = 'PEND' 
