...
class KomplainAModel extends CI_Model
{
    ...
    public function loadManagerKomplainUrgent($divisi)
    {
        ...
        FROM KOMPLAINA k, TOPIK t,DIVISI d WHERE k.TOPIK = t.KODE_TOPIK AND TO_CHAR(k.TGL_DEADLINE - 3) = TO_CHAR(CURRENT_DATE-20) AND t.DIV_TUJUAN = d.KODEDIV AND d.KODEDIV = '$divisi'")->result();
        return $query;
    }
